...
package com.audiokernel.euphonyrmt.service;

import com.audiokernel.euphonyrmt.ConnectionInfo;
import com.audiokernel.euphonyrmt.RemoteControlReceiver;
...
public final class MPDroidService extends Service implements
    ...
    private static final String FULLY_QUALIFIED_NAME = "com.audiokernel.euphonyrmt.service." + TAG;
